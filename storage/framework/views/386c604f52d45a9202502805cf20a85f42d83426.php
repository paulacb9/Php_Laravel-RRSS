                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('like.index')); ?>">Favoritas</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('user.index')); ?>">Gente</a>
                            </li>
                            <li class="nav-item">
...
<?php /**PATH C:\wamp64\www\Curso-PHP\proyecto-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>